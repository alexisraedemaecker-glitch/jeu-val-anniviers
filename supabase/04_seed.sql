...
insert into public.challenges (id, pillar, name, style, tier, points, location_kind, location_detail, proof, sort_order) values
  ...
  ('la-memoire-de-la-mine', 'memoire', 'La mémoire de la mine', 'chill', 'experience', 20, 'typee', 'Là où la mine se raconte encore, à Zinal, dans un musée de la vallée ou chez quelqu''un qui sait', 'photo_quiz', 46),
  ('lillgraben-dans-les-memoires', 'memoire', 'L''Illgraben dans les mémoires', 'chill', 'experience', 20, 'libre', 'N''importe où dans la vallée, là où vous trouvez quelqu''un qui vit ici depuis longtemps', 'photo_quiz', 47),
  ('le-gout-qui-a-disparu', 'memoire', 'Le goût qui a disparu', 'culinaire', 'decouverte', 10, 'libre', 'N''importe où dans la vallée, en discutant avec quelqu''un du coin', 'photo_quiz', 48)
on conflict (id) do update set
