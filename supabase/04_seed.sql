...
insert into public.challenges (id, pillar, name, style, tier, points, location_kind, location_detail, proof, sort_order) values
  ...
  ('ou-va-leau', 'eau', 'Où va l''eau', 'chill', 'decouverte', 10, 'libre', 'Au bord de n''importe quel cours d''eau de la vallée', 'photo_quiz', 13),
  ('le-nom-du-canal', 'eau', 'Le nom du canal', 'culturel', 'decouverte', 10, 'libre', 'N''importe où dans la vallée, le long d''un canal ou d''un bisse', 'photo_quiz', 14),
  ('le-pourquoi-des-bisses', 'eau', 'Le pourquoi des bisses', 'culturel', 'experience', 20, 'typee', 'Le long de n''importe quel bisse de la vallée', 'photo_quiz', 15),
  ('leau-des-glaciers-energie', 'eau', 'L''eau des glaciers, source d''énergie', 'culturel', 'experience', 20, 'typee', 'Depuis un point de vue sur le barrage de Moiry, ou sur un torrent capté', 'photo_quiz', 16),
  ('leau-qui-fait-le-vin', 'eau', 'L''eau qui fait le vin', 'culinaire', 'experience', 20, 'typee', 'Dans un vignoble en aval de la vallée, côté Chippis, Chalais ou Réchy', 'photo_quiz', 17),
  ('mission-secheresse', 'eau', 'Mission sécheresse', 'culturel', 'experience', 20, 'libre', 'N''importe où, ce défi se joue en discutant', 'photo_quiz', 18),
  ('le-geant-de-beton', 'eau', 'Le géant de béton', 'sportif', 'mission', 30, 'precise', 'Barrage de Moiry, sur le couronnement', 'photo_quiz', 19),
  ('la-riviere-qui-vient-de-zinal', 'eau', 'La rivière qui vient de Zinal', 'culturel', 'experience', 20, 'typee', 'Au bord du torrent, côté vallée de Zinal', 'photo_quiz', 20),
  ('les-cornes-qui-saffrontent', 'vie-alpine', 'Les cornes qui s''affrontent', 'chill', 'decouverte', 10, 'libre', 'N''importe où, ce défi est un quiz', 'quiz', 21),
  ('de-lherbe-au-fromage', 'vie-alpine', 'De l''herbe au fromage', 'culinaire', 'decouverte', 10, 'libre', 'N''importe où, ce défi est un quiz', 'quiz', 22),
  ('qui-decide-de-leau-et-de-lherbe', 'vie-alpine', 'Qui décide de l''eau et de l''herbe', 'culturel', 'experience', 20, 'typee', 'Sur n''importe quel alpage, ou le long d''un bisse', 'photo_quiz', 23),
  ('le-rythme-de-la-transhumance', 'vie-alpine', 'Le rythme de la transhumance', 'culturel', 'experience', 20, 'typee', 'Sur n''importe quel alpage de la vallée', 'photo_quiz', 24),
  ('degustation-dalpage', 'vie-alpine', 'Dégustation d''alpage', 'culinaire', 'experience', 20, 'typee', 'Sur un alpage, dans une fromagerie ou un commerce de village', 'photo_quiz', 25),
  ('lalpage-oublie', 'vie-alpine', 'L''alpage oublié', 'sportif', 'mission', 30, 'precise', 'Un alpage qui n''est plus exploité, repéré sur la carte ou indiqué sur place', 'photo_quiz', 26),
  ('lalpage-vivant', 'vie-alpine', 'L''alpage vivant', 'sportif', 'mission', 30, 'precise', 'Un alpage encore en activité, en altitude, à rejoindre à pied', 'photo_quiz', 27),
  ('le-grenier-sur-pilotis', 'patrimoine', 'Le grenier sur pilotis', 'chill', 'decouverte', 10, 'libre', 'Dans n''importe quel village ou hameau de la vallée', 'photo_quiz', 28),
  ('les-traces-du-passe', 'patrimoine', 'Les traces du passé', 'culturel', 'experience', 20, 'precise', 'Un lieu du village dont il existe une vue ancienne, place, église, pont ou rue principale', 'photo_quiz', 29),
  ('le-village-qui-a-change-de-vie', 'patrimoine', 'Le village qui a changé de vie', 'culturel', 'experience', 20, 'typee', 'Dans n''importe quel village de la vallée', 'photo_quiz', 30),
  ('du-four-a-la-table', 'patrimoine', 'Du four à la table', 'culinaire', 'experience', 20, 'typee', 'Un ancien four à pain ou un lieu de production alimentaire de village', 'photo_quiz', 31),
  ('le-chemin-muletier', 'patrimoine', 'Le chemin muletier', 'sportif', 'mission', 30, 'precise', 'Un ancien chemin muletier reliant deux villages de la vallée', 'photo_quiz', 32),
  ('le-hameau-qui-sest-vide', 'patrimoine', 'Le hameau qui s''est vidé', 'sportif', 'mission', 30, 'precise', 'Un hameau ou un mayen délaissé, repéré sur la carte ou indiqué sur place', 'photo_quiz', 33),
  ('les-mots-de-la-vallee', 'memoire', 'Les mots de la vallée', 'chill', 'decouverte', 10, 'libre', 'N''importe où dans la vallée', 'photo_quiz', 34),
  ('qui-se-souvient', 'memoire', 'Qui se souvient', 'culturel', 'decouverte', 10, 'libre', 'N''importe où dans la vallée, là où il y a des gens', 'photo_quiz', 35),
  ('la-neige-davant', 'memoire', 'La neige d''avant', 'culturel', 'experience', 20, 'libre', 'Partout où vous croiserez des habitants, village, terrasse, commerce', 'photo_quiz', 36),
  ('le-repas-de-fete', 'memoire', 'Le repas de fête', 'culinaire', 'experience', 20, 'libre', 'Partout où vous croiserez des habitants', 'photo_quiz', 37),
  ('lobjet-qui-raconte', 'memoire', 'L''objet qui raconte', 'sportif', 'mission', 30, 'precise', 'Un musée local, une collection de village, ou chez une famille', 'photo_quiz', 38),
  ('le-village-qui-a-attendu-la-route', 'memoire', 'Le village qui a attendu la route', 'sportif', 'mission', 30, 'precise', 'Un village longtemps resté isolé, au fond de la vallée ou sur un versant', 'photo_quiz', 39)
on conflict (id) do update set
